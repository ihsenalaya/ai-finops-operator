...
import (
	...
	"github.com/ihsenalaya/ai-finops-operator/internal/recommendationengine"
	"github.com/ihsenalaya/ai-finops-operator/internal/reporting"
...
func (r *AIFinOpsReportReconciler) writeReportConfigMap(ctx context.Context, report *aiopsv1alpha1.AIFinOpsReport, b costengine.Breakdown, collectorName string) error {
	...
	_, err = controllerutil.CreateOrUpdate(ctx, r.Client, cm, func() error {
		...
		cm.Labels["app.kubernetes.io/managed-by"] = "ai-finops-operator"
