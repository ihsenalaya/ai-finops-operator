...
// This file is a trimmed copy of the upstream monolith's
// internal/controller/reconcilers_test.go, keeping only the Describe/Context
// blocks that exercise finops-owned reconcilers (AIProvider, AIGateway,
// AIModel, AIBudgetPolicy, AISovereigntyPolicy, AIBreakEvenAnalysis,
// AIFinOpsReport, AIQualityGate) plus the gateway actuator helper they share.
// The confidential/govar-only contexts (AttestationEvidence, RawAttestationReport,
// AIPlacementDecision, AIKeyReleasePolicy) were dropped along with their
// controllers, which are not part of this module.
