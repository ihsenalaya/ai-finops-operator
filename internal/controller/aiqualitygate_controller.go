...
import (
	...
	"github.com/ihsenalaya/ai-finops-operator/internal/qualityengine"
	"github.com/ihsenalaya/ai-finops-operator/internal/sovereigntyengine"
	platformcrypto "github.com/ihsenalaya/ai-finops-operator/pkg/crypto"
	"github.com/ihsenalaya/ai-finops-operator/pkg/qualitystats"
)
...
func (r *AIQualityGateReconciler) buildEvaluationJob(gate *aiopsv1alpha1.AIQualityGate, jobName, image, endpoint string) *batchv1.Job {
	labels := map[string]string{
		"app.kubernetes.io/name": "ai-finops-operator",
		qualityGateLabel:         gate.Name,
		qualityEvaluatorLabel:    "true",
	}
...
func (r *AIQualityGateReconciler) writeRawEvidence(ctx context.Context, gate *aiopsv1alpha1.AIQualityGate, raw []byte) error {
	...
	cm.Labels["app.kubernetes.io/name"] = "ai-finops-operator"
